...
IL_0009:
	...
	try
	{
		...
		try
		{
			...
			Dictionary_2_set_Item_m3A1A59E6D6AD5DCC0632746846575BB0187E199B(__this, L_3, ((*(int64_t*)UnBox(L_4, il2cpp_rgctx_data(method->klass->rgctx_data, 15)))), il2cpp_rgctx_method(method->klass->rgctx_data, 67));
			goto IL_003a_1;
		}
		catch(Il2CppExceptionWrapper& e)
		{
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR bool Dictionary_2_System_Collections_IDictionary_Contains_m05B25E98233B8F4E3C89D48F671632C22CBE2E1F_gshared (Dictionary_2_tA1B764FC29691A4A96FBE5E6DCFD2819E7D265C8* __this, RuntimeObject* ___0_key, const RuntimeMethod* method) 
{
	...
	}
	{
		RuntimeObject* L_2 = ___0_key;
		bool L_3;
		L_3 = Dictionary_2_ContainsKey_m75FB36FAA5327016F0B98A2E7D53B0F9AC041278(__this, ((*(uint32_t*)UnBox(L_2, il2cpp_rgctx_data(method->klass->rgctx_data, 14)))), il2cpp_rgctx_method(method->klass->rgctx_data, 70));
		return L_3;
	}
