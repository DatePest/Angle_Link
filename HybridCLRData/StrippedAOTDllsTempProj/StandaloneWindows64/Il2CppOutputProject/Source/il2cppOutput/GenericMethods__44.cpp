...
IL_00dc:
	{
		...
		NullCheck(L_38);
		bool L_39;
		L_39 = VirtualFuncInvoker0< bool >::Invoke(88, L_38);
		V_8 = L_39;
		bool L_40 = V_8;
		if (!L_40)
		{
...
IL_02f1:
	{
		...
		NullCheck(L_134);
		bool L_137;
		L_137 = VirtualFuncInvoker1< bool, Type_t* >::Invoke(27, L_134, L_136);
		V_21 = L_137;
		bool L_138 = V_21;
		if (!L_138)
		{
...
IL_0030:
	{
		...
		NullCheck(L_8);
		bool L_11;
		L_11 = VirtualFuncInvoker1< bool, Type_t* >::Invoke(27, L_8, L_10);
		if (L_11)
		{
			goto IL_005b;
		}
