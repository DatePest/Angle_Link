...
public class NetworkTool
    {
        ...
        public static byte[] NetSerialize<T>(T obj, int size = 128) where T : INetworkSerializable, new()
        {
            ...
            try
            {
                FastBufferWriter writer = new FastBufferWriter(size, Allocator.Temp, Network.Msg_size);
...
[System.Serializable]
public class NetworkFilteredData<T> where T : UnityEngine.Object
{
    ...
    public T FindData(string packagname)
    {
        ...
        T data = YooAsset_Tool.GetPackageData<T>(packagname, TargetNameOrId);
